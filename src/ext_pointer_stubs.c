...
value caml_ext_pointer_load_immediate(value p) {
  return *((value *)(caml_ext_pointer_decode(p)));
}

value caml_ext_pointer_store_immediate(value p, value v) {
...
value caml_ext_pointer_load_unboxed_float_bytecode(value p) {
  return caml_copy_double(caml_ext_pointer_load_unboxed_float(p));
}

value caml_ext_pointer_store_unboxed_float_bytecode(value p, value v) {
  return caml_ext_pointer_store_unboxed_float(p, Double_val(v));
}

value caml_ext_pointer_load_unboxed_int64_bytecode(value p) {
  return caml_copy_int64(caml_ext_pointer_load_unboxed_int64(p));
}

value caml_ext_pointer_store_unboxed_int64_bytecode(value p, value v) {
  return caml_ext_pointer_store_unboxed_int64(p, Int64_val(v));
}

value caml_ext_pointer_load_unboxed_int32_bytecode(value p) {
  return caml_copy_int32(caml_ext_pointer_load_unboxed_int32(p));
}

value caml_ext_pointer_store_unboxed_int32_bytecode(value p, value v) {
  return caml_ext_pointer_store_unboxed_int32(p, Int32_val(v));
}

value caml_ext_pointer_load_unboxed_nativeint_bytecode(value p) {
  return caml_copy_nativeint(caml_ext_pointer_load_unboxed_nativeint(p));
}

value caml_ext_pointer_store_unboxed_nativeint_bytecode(value p, value v) {
  return caml_ext_pointer_store_unboxed_nativeint(p, Nativeint_val(v));
}

value caml_ext_pointer_load_untagged_int(value p) {
  return Val_long(caml_ext_pointer_load_unboxed_nativeint(p));
}

value caml_ext_pointer_store_untagged_int(value p, value v) {
