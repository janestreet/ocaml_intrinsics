...
let[@inline] [@zero_alloc] equal (l : t) (r : t) =
  NI.equal (to_nativeint l) (to_nativeint r)
;;

let[@inline] [@zero_alloc] compare (l : t) (r : t) =
  NI.compare (to_nativeint l) (to_nativeint r)
;;

let ( < ) (l : t) (r : t) = (compare [@inlined]) l r < 0
let ( > ) (l : t) (r : t) = (compare [@inlined]) l r > 0
let ( = ) (l : t) (r : t) = equal l r
let ( <= ) (l : t) (r : t) = l < r || l = r
let ( >= ) (l : t) (r : t) = l > r || l = r
let ( <> ) (l : t) (r : t) = not (l = r)
