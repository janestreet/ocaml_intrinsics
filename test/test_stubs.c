...
static inline value encode(void *ptr) { return (value)((uintnat)ptr | 1); }
...
value external_untagged_int_ref(value init) {
  return encode((void *)make_untagged_int(init));
}

value external_immediate_ref(value init) { return encode((void *)make_immediate(init)); }

value external_unboxed_float_ref(value init) {
  return encode((void *)make_unboxed_float(init));
}

value external_unboxed_int64_ref(value init) {
  return encode((void *)make_unboxed_int64(init));
}

value external_unboxed_nativeint_ref(value init) {
  return encode((void *)make_unboxed_nativeint(init));
}

value external_unboxed_int32_ref(value init) {
  return encode((void *)make_unboxed_int32(init));
}

value external_untagged_int_array_ref(value size) {
  return encode(make_untagged_int_array_ref(Long_val(size)));
}

value external_untagged_char_ref_as_native_pointer(value init) {
...
value external_untagged_char_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_untagged_char_ref_as_native_pointer(init));
}

value external_untagged_int_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_untagged_int_ref_as_native_pointer(init));
}

value external_immediate_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_immediate_ref_as_native_pointer(init));
}

value external_unboxed_float_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_unboxed_float_ref_as_native_pointer(init));
}

value external_unboxed_int64_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_unboxed_int64_ref_as_native_pointer(init));
}

value external_unboxed_int32_ref_as_native_pointer_bytecode(value init) {
  return caml_copy_nativeint(external_unboxed_int32_ref_as_native_pointer(init));
}

value external_unboxed_nativeint_ref_as_native_pointer_bytecode(value init) {
